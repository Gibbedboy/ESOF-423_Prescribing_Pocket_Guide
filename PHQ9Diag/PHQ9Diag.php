...
<div class="mainContent">
    ...
    <form id="Questionnaire" action="/action_page.php">
      ...
      3.) Trouble falling asleep, staying asleep, or sleeping to much:<br> <input type="number" min=1 max=4 name="q3"><br>
      4.) Feeling tired or having little energy:<br> <input type="number" min=1 max=4 name="q4"><br>
